...
namespace CollegeSystem.Migrations
{
    ...
    [Migration("20220822081751_subjectday")]
    partial class subjectday
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollegeSystem.Models.SubjectDay", b =>
                {
                    b.Property<int>("subjectID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("subjectID", "dayID");

                    b.HasIndex("dayID");

                    b.ToTable("subjectDay");
                });
            ...
            modelBuilder.Entity("CollegeSystem.Models.SubjectDay", b =>
                {
                    b.HasOne("CollegeSystem.Models.AcademicDay", "AcademicDay")
                        .WithMany("subjects")
                        .HasForeignKey("dayID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
